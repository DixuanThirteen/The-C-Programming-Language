        ...
        switch (type)
        {
            ...
            case '%':
                ...
                if(pop2 != 0.0)
                    ...
                    printf("error: zero divisor\n");
                break;
            case 'p':/* print top element 打印栈顶元素 */
                if(sp > 0){
            ...
            case 'd':/* duplicate top element 复制栈顶元素 */
                if(sp > 0){
				    pop2 = pop();
				    push(pop2);
				    push(pop2); 
            ...
            case 'e':/* exchange top two elements 交换栈顶两个元素 */
                if(sp > 1){
                    double pop1 = pop();
                    pop2 = pop();
                    push(pop1);
...
int getop(char s[]){
    ...
    if( c == 'p' || c == 'd' || c == 'e' || c == 'c') /* check for commands 检查是否是命令 */
        return c;
